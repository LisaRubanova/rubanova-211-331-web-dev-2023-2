...
#регистрация и связывание со страницей
# параметры
#   1: какой BP
...
def logging():
    ...
    return render_template('visits/logs.html', 
        start_index = (page-1)*10, logs = logs, last_page = last_page, current_page = page)
...
def download_statistic_pages():
    ...
    with open("statistic.csv", "w", newline="") as csv_file:
        ...
        #csv.DictWriter отображает словари в CSV-файл
        writer = csv.DictWriter(csv_file, fieldnames=columns)
        #writeheader() — записывает данные строки заголовка в CSV-файл
        writer.writeheader()
        #записывание всех строки из словаря
